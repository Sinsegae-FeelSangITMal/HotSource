			...
			<div class="row">
						...
						<div class="product__details__slider__content">
							<div class="product__details__pic__slider owl-carousel">
								<img data-hash="product-1" class="product__big__img"
									src="img/product/details/product-1.jpg" alt=""> <img
									data-hash="product-2" class="product__big__img"
									src="img/product/details/product-3.jpg" alt=""> <img
									data-hash="product-3" class="product__big__img"
									src="img/product/details/product-2.jpg" alt=""> <img
				...
				<div class="col-lg-4">
					<div class="product__details__text">
						<h3><%=dto.getAsset().getTitle() %> <span><img src="/static/images/test1.gif"
								style="width: 30px;"> <%=dto.getAsset().getSeller().getSeller_name() %></span>
						</h3>
						<div class="rating">
				...
				<!-- 탭 버튼 -->
					...
					<div class="custom-tab-contents">
						...
						<div id="tab-profile" class="custom-tab-panel">프로필 탭 내용</div>
						<div id="tab-contact" class="custom-tab-panel">연락처 탭 내용</div>
					</div>
				</div>
