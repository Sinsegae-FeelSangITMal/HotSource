				...
				<tr>
					...
					<td>
						<div class="download-wrap">
							<a class="download active" href="javascript:void(0)" onclick="openDownloadPopup(this)">Download</a>
							<a class="download <%= (oa.getReview() != null) ? "disable" : "active" %>"
							    ...
							    <% if (oa.getReview()!=null) {%>Show Review
							    <%} else {%>Write a Review<%} %>
							</a>
						</div>
					</td>
...
<%@ include file="popup_download.jsp" %>